...
s32
Win32WindowService::GetWindowEvents(Win32Window *window, Sys_Event *events, s32 max_event_count)
{
    s32 event_count = 0;
...
#undef ADD_KEY_EVENT
            ...
            case WM_SIZE:
            {
                s32 width = (s32)LOWORD(msg.lParam);
                s32 height = (s32)HIWORD(msg.lParam);
