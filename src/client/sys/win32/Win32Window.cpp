...
bool
Win32Window::RecreateOffscreenBuffer(s32 width, s32 height)
{
...
{
    s32 width = m_OffscreenBuffer.sys_offscreen_buffer.width;
    s32 height = m_OffscreenBuffer.sys_offscreen_buffer.height;
